...
class _CartPageState extends State<CartPage> {
  ...
  void removeFromCard(Coffee coffee){
    ...
    void removeFromFavorite(Coffee coffee){
    Provider.of<CoffeeShop>(context, listen: false).removeItemFromFavorite(coffee);
  }
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: Color(0xFF870000), borderRadius: BorderRadius.circular(12)),
